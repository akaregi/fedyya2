<template>
  <div class="links">
    ...
    <LinkBox
      class="is-twitter"
      title="Twitter"
      lead="あかれぎのツイッターアカウントです。"
      url="https://twitter.com/akgmoegi"
    />
    ...
    <div class="notification">
      <p>🔗 リンク先の方へ： 上のソーシャルメディア的な色付けや説明文をご所望でしたらご連絡ください。</p>
    </div>
...
@Component({ components: { TitleHero, LinkBox } })
